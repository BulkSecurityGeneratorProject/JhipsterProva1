...
public class Jaguar implements Serializable {
    ...
    public Jaguar nombre(String nombre) {
        this.nombre = nombre;
        return this;
    }
    ...
    public Jaguar anoCreacion(LocalDate anoCreacion) {
    ...
    public Jaguar descripcion(String descripcion) {
    ...
    public Jaguar fotoContentType(String fotoContentType) {
    ...
    public Jaguar goodCat(Boolean goodCat) {
    ...
    public boolean equals(Object o) {
        ...
        if (jaguar.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), jaguar.getId());
    }
